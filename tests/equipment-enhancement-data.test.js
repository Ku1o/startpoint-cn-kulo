...
const UNRELATED_ROWS_SHA256 = "2aa57accb358928d698d80c0b3b9e7eab5bac6eaedf8c8a1d9ebd06edbb362e1"

test("only Liberator and Terminator gain the new 13-stage shop rows", () => {
    assert.equal(Object.keys(shop).length, 215)
    ...
    const digest = crypto.createHash("sha256")
        ...
        .digest("hex")
    assert.equal(Object.keys(unrelatedRows).length, 189)
