...
function getRankingSummary(playerId, eventId) {
    var _a, _b, _c, _d;
    // get quest
    const questId = activity_degree_rewards_1.rankingEventIdQuestMap[eventId];
    ...
    const placement = (0, activity_degree_rewards_1.getRankingPlacementSync)(playerId, eventId);
    return {
        "best_record": {
        ...
        "rank_percentage": (_d = placement === null || placement === void 0 ? void 0 : placement.percentile) !== null && _d !== void 0 ? _d : 1
    };
}
const routes = (fastify) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fastify.post("/receive_reward", (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const degreeIds = (0, activity_degree_rewards_1.grantEligibleRankingEventDegreesSync)(playerId, eventId);
        reply.header("content-type", "application/x-msgpack");
        return reply.status(200).send({
            "data_headers": (0, utils_1.generateDataHeaders)({
                viewer_id: viewerId
            }),
            "data": Object.assign({ "status": 1, "degree_list": degreeIds.map(degreeId => ({
                    viewer_id: viewerId,
                    degree_id: degreeId,
                })) }, summary)
        });
