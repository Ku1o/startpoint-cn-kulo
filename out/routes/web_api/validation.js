...
exports.VALID_CHARACTER_IDS = new Set(Object.keys(content_master_1.serverCharacters).map(Number));
exports.VALID_ITEM_IDS = new Set(content_master_1.serverItemIds);
